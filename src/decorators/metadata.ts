...
export interface CommandMethodMetadata extends Partial<CommandMetadata> {
...
export function setCogMetadata(
    metadata: Record<PropertyKey, unknown>,
    value: CogMetadata,
): void {
...
export function getCogMetadata(
    metadata: Record<PropertyKey, unknown>,
): CogMetadata | undefined {
    return metadata[cogMetadataKey] as CogMetadata | undefined;
}

export function addCommandMethodMetadata(
    metadata: Record<PropertyKey, unknown>,
    value: CommandMethodMetadata,
): void {
    const methods =
        (metadata[commandMethodsMetadataKey] as CommandMethodMetadata[] | undefined) ??
        [];
    methods.push(value);
...
export function getCommandMethodMetadata(
    metadata: Record<PropertyKey, unknown>,
): readonly CommandMethodMetadata[] {
    return (
        (metadata[commandMethodsMetadataKey] as CommandMethodMetadata[] | undefined) ??
        []
    );
...
export function addListenerMethodMetadata(
    metadata: Record<PropertyKey, unknown>,
    value: ListenerMethodMetadata,
): void {
    const methods =
        (metadata[listenerMethodsMetadataKey] as ListenerMethodMetadata[] | undefined) ??
        [];
    methods.push(value);
    metadata[listenerMethodsMetadataKey] = methods;
}

export function getListenerMethodMetadata(
    metadata: Record<PropertyKey, unknown>,
): readonly ListenerMethodMetadata[] {
    return (
        (metadata[listenerMethodsMetadataKey] as ListenerMethodMetadata[] | undefined) ??
        []
    );
